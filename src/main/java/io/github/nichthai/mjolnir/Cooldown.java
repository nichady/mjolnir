...
public final class Cooldown
{
    ...
    public boolean ready(final Entity entity) { return getSecondsRemaining(entity, false) <= 0; }
    public void put(final Player player, final double seconds) { map.put(player.getUniqueId(), (long) (System.currentTimeMillis() + seconds * 1000)); }
